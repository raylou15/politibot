...
data: new SlashCommandBuilder()
    ...
    async execute(interaction, client) {
        ...
        if (interaction.options.getSubcommand() === 'contact') {
            ...
            .setColor("Yellow")
            .setDescription("The Operation Politics Staff has opened a ticket with you. Please await a response below.")
            .setFooter({ text: "If you do not receive a response after a while, please feel free to let us know." })
            ...
            const ticketPreview = new EmbedBuilder()
                ...
                .setFields([
                    ...
                    { name: "Reason:", value: "First contact originated by a Moderator.", inline: true },
            ...
            ticketHandler.TicketCreate(client, ticketName, ticketCat, ticketPreview, ticketButtons, ticketContact, interaction)

            await interaction.reply({ content: "A new ticket has been opened.", ephemeral: true })
