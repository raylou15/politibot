      ...
      .then(async (interaction) => {
        if (interaction.customId === "cancelrulesreminder") {
          ...
          const r1Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 1, or heading in the direction of violating the rule. This is not a warning, but just a reminder to be respectful and civil in your conversations.`
            )
          ...
          updateInteractionSent(interaction);
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 2, or heading in the direction of violating the rule. This is not a warning, but just a reminder to be respectful and civil in your conversations.`
            )
          ...
          const r3Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 3, or heading in the direction of violating the rule. This is not a warning, but just a reminder to be respectful and civil in your conversations.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r4Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 4, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid treading into political extremism.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r5Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 5, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid treading into prejudicial or hateful behavior or comments.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
                `> **Rule 5 - No Bigotry**`,
          ...
          const r6Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 6, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid making discriminatory comments or posts.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          r7reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 7, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid making spammy posts or misusing channels.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          r8reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 8, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid making unsolicited posts or sending unsolicited DMs, and follow all Communiuty Guidelines.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r9Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 9, or heading in the direction of violating the rule. This is not a warning, but just a reminder to make sure your profile is in line with the server rules.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const R10Reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 10, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid making malicious comments or posts.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r11reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 11, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid posting disinformation.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r12reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 12, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid posting content that is related to banned topics, and be careful when discussing heavily moderated topics.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const r13reminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating Rule 13, or heading in the direction of violating the rule. This is not a warning, but just a reminder to avoid making posts that are overtly bad faith.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              [
          ...
          const englishReminder = new ContainerBuilder()
            ...
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
              `Messages or conversations in this channel are potentially violating the English Only rule. This is not a warning, but just a reminder to please post content in English.`
            ))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(
